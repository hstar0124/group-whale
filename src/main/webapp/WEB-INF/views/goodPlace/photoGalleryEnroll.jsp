	...
	<div class="wrap">
		...
		<div class="content">
			...
			<div class="contentDiv" style="width: 855px; border: 0px;">
				<form action="insertPboard.gp" method="post" id="insertForm" enctype="multipart/form-data">
					<div class="topDiv">
						<input id="titleInput" name="title" type="text" style="width: 570px;"
							placeholder="제목을 입력해주세요." autofocus="autofocus"> <br>
						<br>
