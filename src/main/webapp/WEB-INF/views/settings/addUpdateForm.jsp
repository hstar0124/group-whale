...
<body>
	...
	<jsp:include page="settingsMenu.jsp" />
		...
		<div class="content">
			<b class="contentTitle" style="font-size:17px;">문서양식 수정</b>
			<br><br>
			<div class="contentDiv" style="border:0px";>
			<form action="updateDocumentForm.st" id="updateDocForm" method="post">
				<table id="formTab">
					<tr>
						<td>보존연한</td>
				...
				<input type="hidden" name="cboxNo" value="${ form.cboxNo }">
				<input type="hidden" name="formNo" value="${ form.formNo }">
				<hr>
				<div style="margin-left:10px;">
					<label>제목 :</label>&nbsp;&nbsp;&nbsp;<input type="text" name="formName" id="formName" style="width:750px;" value="${ form.formName }">
					<div class="textDiv">
	...
	$(document).ready(function() {
		...
		$("input[name='formTerm']:input[value='"+ ${form.formTerm} + "']").attr("checked", true);
		$("input[name='formDelegate']:input[value='"+ ${form.formDelegate} + "']").attr("checked", true);
		$("input[name='formUse']:input[value='"+ ${form.formUse} + "']").attr("checked", true);
