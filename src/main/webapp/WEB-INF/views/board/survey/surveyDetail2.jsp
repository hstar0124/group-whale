		...
		<div class="content">
			...
			<div class="contentDiv" style="width:800px">
				...
				<table>
					...
					<tr>
						<!-- <td colspan="2" style="text-align:left;"><input type="text" value="행정팀" style="text-align:center; width:100px; border:2px solid #0871B9;"></td> -->
						...
						<td style="text-align:left;">
							...
							<input type="hidden" name="aWriter" value="${loginUser.empNo }" style="text-align:center; width:150px; border:2px solid lightgray;">
						...
						<td style="text-align:right;">
                          		<button type="submit" class="formBtn" id="deadlineBtn">마감</button>
...
<!-- ---------------------------------------------------------------------------------------------------------------- -->					
					...
					<c:forEach var="sureveyAnswer" items="${ list5 }" varStatus="status">
					<tr style="height:40px">
						<td colspan="3" style="text-align:left;">
							<label class="box-radio-input">
								<input type="radio" name="surveyQuestionNo" value="${sureveyAnswer.surveyQuestionNo}" checked="checked">
								<span style="text-align:left;">${sureveyAnswer.surveyQuestionContent}</span>
							</label>
						</td>
					</tr>
					</c:forEach>
...
<!-- ---------------------------------------------------------------------------------------------------------------- -->
					...
					<tr>
                     ...
                     <tr>
                        ...
                        <br><br>
                           <button type="reset" class="formBtn" id="submitBtn" onclick="location.href='surveyDetail1.bo;'">재설문</button>
