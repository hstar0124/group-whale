	...
	<!-- board 메뉴바 include -->
		...
		<div class="content">
			...
			<div class="contentDiv" style="width:850px">
				<br>
				<form method="post" action="insertAllBoardForm.bo" enctype="multipart/form-data">
				<table>
					<colgroup>
						<col width="8%" />
						<col width="77%" />
					...
					<tr>
						...
						<td style="text-align:left;"><input type="text" name="aTitle" style="width:500px; border:2px solid lightgray;"></td>
					...
					<tr rowspan="2">
						...
						<td class="td1" style="text-align:left;" colspan="2">
								<div id="textDiv">
 								 	<textarea id="summernote" name="aContent" style="overflow-x:hidden; overflow-y:auto;"></textarea>
								</div>
							</td>
					...
					<tr>
						...
						<div class="filebox bs3-primary">
                          ...
                          <input name="file" type="file" id="ex_filename" class="upload-hidden"> 
                        </div>
						</td>
					</tr>
					 ...
					 <tr>
                        ...
                        <br><br>
                           ...
                           <button type="reset" id="cancelBtn" onclick="location.href='selectListAllBoard.bo;'">취소</button>
                        </label>
                        </td>
                     </tr>
				</table>
