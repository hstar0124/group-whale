...
<body>
	...
	<jsp:include page="../common/menubar.jsp" />
   	<jsp:include page="../approval/approvalMenubar.jsp"/>
		...
		<div class="content">
			<b class="contentTitle" style="font-size:18px;">결재요청함</b>
			<br><br>
				...
				<div style="height:470px;">
					<table id="draftTab">
						...
						<c:if test="${ empty boxList }">
							<td colspan="8" rowspan="10"><div style="text-align:center; line-height:90px; color:#a5a5a5;"> 요청한 문서가 없습니다. </div></td>
						</c:if>
						<c:if test="${ ! empty boxList }">
