...
<body>
	<div class="wrap">
		...
		<div class="content">
			<b class="contentTitle" style="font-size: 18px;">결재진행함</b> <br>
			<br>
			<div class="contentDiv" style="border: 0px;">
				...
				<div style="height:470px;">
					<table id="proceedTab">
						...
						<tr>
							...
							<th style="width: 50px;">긴급</th>
							<th style="width: 250px;">제목</th>
							<th style="width: 100px;">기안자</th>
							<th style="width: 90px;">기안일</th>
							<th style="width: 90px;">결재일</th>
						...
						<c:if test="${ empty boxList }">
							<td colspan="8" rowspan="10"><div style="text-align:center; line-height:90px; color:#a5a5a5;"> 진행중인 문서가 없습니다. </div></td>
						</c:if>
						<c:if test="${ ! empty boxList }">
							<c:forEach var="b" items="${ boxList }">
								<tr class="boxListTr">
									...
									<td>${b.docTitle }</td>
									<td>${ b.empName }</td>
									<td><div class="enrollDateDiv">${ b.enrollDate }</div></td>
									<td><div class="appDateDiv">${ b.appDate }</div></td>
									<td>
				...
				<div id="pagingDiv" align="center">
					<ul class="pagination">
						...
						<c:if test="${ pi.currentPage > 1 }">
							<c:url var="blistBack" value="goAppProceed.ap">
						...
						<c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">
							...
							<c:if test="${ p ne pi.currentPage }">
								<c:url var="blistCheck" value="goAppProceed.ap">
						...
						<c:if test="${ pi.currentPage < pi.endPage }">
							<c:url var="blistEnd" value="goAppProceed.ap">
							<c:param name="currentPage" value="${ pi.currentPage + 1 }" />
							</c:url>
							<li>
								<a href="${ blistEnd }">
