...
<body>
	<div class="wrap">
		...
		<div class="content">
			<b class="contentTitle" style="font-size: 18px;">반려문서함</b> <br>
			<br>
			<div class="contentDiv" style="border: 0px;">
				...
				<div style="height:470px;">
					<table id="rejectTab">
						...
						<c:if test="${ empty boxList }">
							<td colspan="7" rowspan="10"><div style="text-align:center; line-height:90px; color:#a5a5a5;"> 반려된 문서가 없습니다. </div></td>
						</c:if>
						<c:if test="${ ! empty boxList }">
				...
				<div id="pagingDiv" align="center">
					<ul class="pagination">
						...
						<c:if test="${ pi.currentPage > 1 }">
							<c:url var="blistBack" value="goAppReject.ap">
						...
						<c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">
							...
							<c:if test="${ p ne pi.currentPage }">
								<c:url var="blistCheck" value="goAppReject.ap">
						...
						<c:if test="${ pi.currentPage < pi.endPage }">
							<c:url var="blistEnd" value="goAppReject.ap">
							<c:param name="currentPage" value="${ pi.currentPage + 1 }" />
							</c:url>
							<li>
								<a href="${ blistEnd }">
