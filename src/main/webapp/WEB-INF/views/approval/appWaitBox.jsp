...
<body>
	<div class="wrap">
		...
		<div class="content">
			<b class="contentTitle" style="font-size: 18px;">결재대기함</b> <br>
			<br>
			<div class="contentDiv" style="border: 0px;">
				<div class="searchDiv" style="text-align: right; height: 40px;">
				...
				<%-- <div style="height: 40px;">
					<img src="${ contextPath }/resources/images/approval/check.png"
						style="width: 25px; height: 20px;"> &nbsp; <label>일괄결재</label>
				</div> --%>
				<div style="height:470px;">
					<table id="waitTab">
						...
						<c:if test="${ empty boxList }">
							<td colspan="8" rowspan="10"><div style="text-align:center; line-height:90px; color:#a5a5a5;"> 결재 대기 문서가 없습니다. </div></td>
						</c:if>
						<c:if test="${ ! empty boxList }">
							<c:forEach var="b" items="${ boxList }">
								<tr class="boxListTr">
									<input type="hidden" value="${ b.docNo }">
									<td style="padding-left:7px;">${listCount - b.num + 1 }</td>
						...
						<%-- <tr>
							...
							<td><img
								...
								style="width: 15px; height: 15px;">&nbsp;1</td>
							<td>박해영</td>
							<td><div class="sg_status">진행중</div></td>
						</tr>
						<tr>
							<td><input type="checkbox"
								style="width: 16px; height: 16px;"></td>
				...
				<div id="pagingDiv" align="center">
					<ul class="pagination">
						...
						<c:if test="${ pi.currentPage > 1 }">
							<c:url var="blistBack" value="goAppWait.ap">
						...
						<c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">
							...
							<c:if test="${ p ne pi.currentPage }">
								<c:url var="blistCheck" value="goAppWait.ap">
						...
						<c:if test="${ pi.currentPage < pi.endPage }">
							<c:url var="blistEnd" value="goAppWait.ap">
							<c:param name="currentPage" value="${ pi.currentPage + 1 }" />
							</c:url>
							<li>
								<a href="${ blistEnd }">
