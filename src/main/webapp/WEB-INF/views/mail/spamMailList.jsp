   ...
   <jsp:include page="mailMenubar.jsp" />
		...
		<div class="content" style="background:white;">
         ...
         <td style="width:70px;"class="buttonTable_td"><div onclick="location.href=''"><img class="nav1_icons" style="width:20px; height:20px"
               src="/gw/resources/images/mail/return.png">&nbsp;답장</div></td>
                  ...
                  <td style="width:80px;" class="buttonTable_td" >
                     ...
                     <label class="dropdown mailDelete" style="margin-top: 2px; padding-top: 3px; font-weight: normal; color:black;">
                        ...
                        <ul class="dd-menu">
                           <li onclick="">임시삭제</li><!-- 휴지통으로 보내기 -->
                           <li onclick="">완전삭제</li><!-- 삭제하기 -->
                        </ul>
                     </label>
                  </div>
               </td>
			...
			<td style="width:30px;" class="important"><img class="nav1_icons"  style="width:20px; height:20px"
					src="/gw/resources/images/mail/star2.png" onclick="changeImage()"></td>
			...
			<td style="width:30px;"><img class="nav1_icons" style="width:20px; height:20px"
				...
				<td style="width:300px; text-overflow: ellipsis; "><c:out value="${ m.from }"/></td><!--  여기는 보낸 사람 이메일-->
	...
	<script>
		...
		function changeImage(){
			...
			if(state = 0){
				state = 1;
				$(this).prop("src","/gw/resources/images/mail/star.png");
				}else{
				state = 0;
				$(this).prop("src","/gw/resources/images/mail/star2.png");
				}
		}
	</script>
