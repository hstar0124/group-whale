	 ...
	 <jsp:include page="mailMenubar.jsp" />
		...
		<div class="content" style="background:white;">
           ...
           <table style="margin-top:30px; margin-left:130px; font-size:15px;">
           	<tr>
           		<td style="width:100px; height:30px;"><b>보낸 사람</b></td>
           		<td>${ map.from }</td> 
           	</tr>
           	<tr>
           		<td style="width:100px; height:30px;"><b>받는 사람</b></td>
           		<td>${ receiver }</td>
           	</tr>
           	<tr>
           		<td style="width:100px; height:30px;"><b>보낸 날짜</b></td>
           		<td>${ map.mailEnrollDate }</td>
           	</tr>
           </table>
		
			<!-- <div style="width:1000px; height:30px; background-color:#C4C4C4; margin-left:150px; margin-top:30px; padding:5px;" > -->
				<h4>첨부 파일</h4>
